...
public abstract class AsneChunkGenerator<SETTINGS extends GenerationSettings> extends NoiseChunkGenerator<SETTINGS> {
    ...
    private final PerlinNoiseGenerator depthNoise;
    ...
    public AsneChunkGenerator(IWorld worldIn, BiomeProvider provider, SETTINGS settingsIn) {
        super(worldIn, provider, 4, 8, 256, settingsIn, true);
        this.randomSeed.skip(2620);
        this.depthNoise = new PerlinNoiseGenerator(this.randomSeed, 1, 1);
