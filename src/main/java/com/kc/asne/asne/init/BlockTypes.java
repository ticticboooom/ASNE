...
import com.kc.asne.asne.block.ManualPressController;
...
public class BlockTypes {
    ...
    public static final RegistryObject<Block> MANUAL_PRESS_CONTROLLER = BLOCKS.register("manual_press_controller", ManualPressController::new);
}
